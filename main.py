...
def main(config_file):
    """
    Main function to execute the hydrological simulation.
    ...
    wt_track_drained = tuple(config['tracking']['wt_track_drained'])
    wt_track_notdrained = tuple(config['tracking']['wt_track_notdrained'])
...
if __name__ == "__main__":
    config_filename = "data/sugihan-lumpur_data/default_data_parameters.yml"
