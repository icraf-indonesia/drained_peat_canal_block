...
dem_rst_fn = r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/sugihan-lumpur_data/dsm_alos_3d_oki.tif" #r"data/dataset_v1/11Dataset_v1new/DatasetV1-new/srtm_clipped_DI_res.tif" #preprocessed_datafolder + r"/02Elevasi/Demnas_KHG_SL.tif" 
can_rst_fn = r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/sugihan-lumpur_data/canal_new_res.tif"  #preprocessed_datafolder + r"/03CanalNetwork/Canal_rcl_F.tif"
peat_depth_rst_fn = r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/sugihan-lumpur_data/peattype_new_res.tif" #preprocessed_datafolder + r"/04Peat/Peat depth.tif" # peat depth, peat type in the same raster

# <<<<<<< HEAD
# # abs_path_data = os.path.abspath('/data') # Absolute path to data folder needed for Excel file with parameters
params_fn = r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/sugihan-lumpur_data/params.xlsx" #abs_path_data + r"/params.xlsx"
rainfall_fn = r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/sugihan-lumpur_data/2023_rainfall_plm.xlsx" #r"D:/OneDrive - CIFOR-ICRAF/Documents/GitHub/peat_canal_block/python3/data/dataset_v1/06Rainfall/2023_rainfall_plm.xlsx"
# =======
